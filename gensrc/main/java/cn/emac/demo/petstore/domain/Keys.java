...
import cn.emac.demo.petstore.domain.tables.records.*;
...
public class Keys {
	...
	private static class ForeignKeys0 extends AbstractKeys {
		public static final ForeignKey<ItemRecord, ProductRecord> ITEM_IBFK_1 = createForeignKey(cn.emac.demo.petstore.domain.Keys.KEY_PRODUCT_PRIMARY, Item.ITEM, Item.ITEM.PRODUCTID);
		public static final ForeignKey<ItemRecord, SupplierRecord> ITEM_IBFK_2 = createForeignKey(cn.emac.demo.petstore.domain.Keys.KEY_SUPPLIER_PRIMARY, Item.ITEM, Item.ITEM.SUPPLIER);
		public static final ForeignKey<ProductRecord, CategoryRecord> PRODUCT_IBFK_1 = createForeignKey(cn.emac.demo.petstore.domain.Keys.KEY_CATEGORY_PRIMARY, Product.PRODUCT, Product.PRODUCT.CATEGORY);
	}
}
