...
import cn.emac.demo.domain.jpetstore.tables.records.AccountRecord;
import cn.emac.demo.domain.jpetstore.tables.records.BannerdataRecord;
import cn.emac.demo.domain.jpetstore.tables.records.CategoryRecord;
import cn.emac.demo.domain.jpetstore.tables.records.InventoryRecord;
import cn.emac.demo.domain.jpetstore.tables.records.ItemRecord;
import cn.emac.demo.domain.jpetstore.tables.records.LineitemRecord;
import cn.emac.demo.domain.jpetstore.tables.records.OrdersRecord;
import cn.emac.demo.domain.jpetstore.tables.records.OrderstatusRecord;
import cn.emac.demo.domain.jpetstore.tables.records.ProductRecord;
import cn.emac.demo.domain.jpetstore.tables.records.ProfileRecord;
import cn.emac.demo.domain.jpetstore.tables.records.SequenceRecord;
import cn.emac.demo.domain.jpetstore.tables.records.SignonRecord;
import cn.emac.demo.domain.jpetstore.tables.records.SupplierRecord;
...
public class Keys {
	...
	private static class ForeignKeys0 extends AbstractKeys {
		public static final ForeignKey<ItemRecord, ProductRecord> ITEM_IBFK_1 = createForeignKey(cn.emac.demo.domain.jpetstore.Keys.KEY_PRODUCT_PRIMARY, Item.ITEM, Item.ITEM.PRODUCTID);
		public static final ForeignKey<ItemRecord, SupplierRecord> ITEM_IBFK_2 = createForeignKey(cn.emac.demo.domain.jpetstore.Keys.KEY_SUPPLIER_PRIMARY, Item.ITEM, Item.ITEM.SUPPLIER);
		public static final ForeignKey<ProductRecord, CategoryRecord> PRODUCT_IBFK_1 = createForeignKey(cn.emac.demo.domain.jpetstore.Keys.KEY_CATEGORY_PRIMARY, Product.PRODUCT, Product.PRODUCT.CATEGORY);
	}
}
